    ...
    <div class="hy-card">
      <div class="clearfix nav-wrap">
        <el-menu size="mini" class="sub-menu-nav pull-left" mode="horizontal" :default-active="$route.path" :router="true">
          <el-menu-item index="/report/advertiser">
            广告主报告
          </el-menu-item>
          <el-menu-item index="/report/brand">
            品牌报告
          </el-menu-item>
          <el-menu-item index="/report/productline">
            产品线报告
          </el-menu-item>
          <el-menu-item index="/report/project">
            项目报告
          </el-menu-item>
          <el-menu-item index="/report/activity">
            活动报告
          </el-menu-item>
          <el-menu-item index="/report/campaign">
            推广计划报告
          </el-menu-item>
          <el-menu-item index="/report/custom">
            定制报告
          </el-menu-item>
        </el-menu>
