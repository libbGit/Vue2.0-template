      ...
      <div class="hy-card" >
        <div class="hy-card__header clearfix">
          <div class="pull-right">
            <el-input placeholder="请输入点位名称" v-model="keywords" size="mini" style="width:200px;">
            ...
            <el-date-picker size="mini" :clearable="false"
              ...
              :picker-options="campPointDROptions"
        ...
        <div class="hy-card__content">
          <el-table ref="table" border size="mini" max-height="510"
            ...
            <el-table-column prop="posName" label="点位"></el-table-column>
    ...
    methods:{
      ...
      initList(){
        ...
        if (this.pageType == 'campaign') {
          url = '/campaign/relate_position';
          setData.campaign_id = this.campaign_id;
        }else{
          url = '/campaign/position';
