        ...
        <div class="hy-card__content"
            ...
            <div style=' padding: 10px 20px'>
                ...
                <div class="filter">
                    ...
                    <el-select v-model="placefile"
                        size="mini">
                        <el-option v-for="item in placefileOption"
                            :key="item.value"
                            :label="item.label"
                            :value="item.value">
                        </el-option>
            ...
            <creative-table :data='creativeData'
                :placefile='placefile'
